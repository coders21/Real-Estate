...
class PropertyPublishedManager(models.Manager):  #custom manager
...
class Property(TimeStampedUUIDModel):
    ...
    slug = AutoSlugField(populate_from="title", unique=True, always_update=True)  # its generated from title used for good naming SEO practice
    ...
    def __str__(self):   # when we open admin it will show with title string
        return self.title
